...
public class Driver  {
    ...
    private static boolean checkLogin(){
        try {
            BufferedReader br = new BufferedReader(new FileReader("D:\\III Semestr\\OOP\\lab5\\src\\task2\\admin.txt"));
            String log = sc.next();
            String pass = sc.next();
            String hash = "";
    ...
    private static void adminMenu(){
        ...
        if(oper >= 1 && oper <=5) {
            try {
                BufferedWriter bw = new BufferedWriter(new PrintWriter(new FileWriter(new File("D:\\III Semestr\\OOP\\lab5\\src\\task2\\admin.txt"), true)));
                if(logadmin){
